...
export const domains = new Elysia({ prefix: '/domains' }).post(
	...
	},
	{
		...
		detail: {
			...
			description:
				'Check domain availability across multiple TLDs using RDAP. Accepts domain keyword (e.g., "example") or full domain (e.g., "example.com"). If TLDs not specified, extracts from domain or defaults to ["com", "id", "ai", "org", "net", "io"]',
			tags: ['Domains'],
		},
	}
);
